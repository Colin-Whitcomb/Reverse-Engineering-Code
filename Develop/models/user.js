...
module.exports = function (sequelize, DataTypes) {
  ...
  User.prototype.validPassword = function (password) {
    // compares user password input to what is stored in the db (hashed)
  ...
  User.addHook("beforeCreate", function (user) {
    // hashes password of the user so that the item stored in db is an encrypted version of itself
